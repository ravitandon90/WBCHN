...
HEN (1:Number_High_Energy_Nodes, 1:2) = Sensor_Nodes (Number_Low_Energy_Nodes+1:Number_Low_Energy_Nodes+Number_High_Energy_Nodes, 1:2);
LEN (1:Number_High_Energy_Nodes, 1:2)= Sensor_Nodes (1:Number_High_Energy_Nodes, 1:2);
